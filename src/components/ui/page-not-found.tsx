  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      <div className="text-center max-w-xl">
        <h1 className="text-5xl md:text-7xl font-bold mb-6" style={{ color: "#f5f5f5" }}>Oh no! You got lost walking on the bridge.</h1>
        <p className="text-lg mb-8" style={{ color: "rgba(245,245,245,0.85)" }}>
          This page does not exist. Let us get you back.
        </p>
