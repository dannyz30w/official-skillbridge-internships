...
const Footer = () => (
  <footer className="py-16 px-4 sm:px-6" style={{ borderTop: '1px solid rgba(255,255,255,0.5)' }} role="contentinfo">
    <div className="container mx-auto max-w-4xl">
      <div className="flex flex-col sm:flex-row items-start justify-between gap-8">
        ...
        <div className="grid grid-cols-2 gap-x-16 gap-y-4 text-small">
          <div>
            ...
            <ul className="space-y-3" style={{ color: 'rgba(60,60,67,0.6)' }}>
              <li><Link to="/browse" className="transition-fast hover:text-foreground">Browse Internships</Link></li>
              <li><Link to="/for-businesses" className="transition-fast hover:text-foreground">For Businesses</Link></li>
              <li><a href="/#how-it-works" className="transition-fast hover:text-foreground">How It Works</a></li>
            </ul>
          </div>
          <div>
      ...
      <div className="mt-12 pt-8 text-caption" style={{ borderTop: '1px solid rgba(255,255,255,0.5)', color: 'rgba(60,60,67,0.4)' }}>
