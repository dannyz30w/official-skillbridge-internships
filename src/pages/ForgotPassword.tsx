  ...
  return (
    <div className="min-h-screen flex flex-col relative z-10" style={{ background: 'transparent' }}>
      ...
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.38, ease }} className="p-6">
        <Link to="/signin" className="inline-flex items-center gap-2 text-small font-medium text-white/50 hover:text-white transition-colors">
      ...
      <div className="flex-1 flex items-center justify-center px-4 pb-16">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.38, ease, delay: 0.04 }} className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-body text-white/50" style={{ fontFamily: "var(--font-body)" }}>Enter your email to receive a reset link.</p>
          </div>
          {sent ? (
            <div className="liquid-glass-strong rounded-2xl p-8 text-center">
              <p className="text-body text-white/60">Check your inbox for a password reset link. If you do not see it, check your spam folder.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="fp-email" className="block text-small font-medium mb-2 text-white/50">Email</label>
